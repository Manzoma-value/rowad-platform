...
export const APP_UI = {
  ar: {
    ...
    incompleteTitle: "أكمل الحقول المحددة قبل المتابعة",
    nextStep: "التالي",
    previousStep: "السابق",
    saved: "تم حفظ المسودة",
    saving: "جارٍ حفظ المسودة…",
    savedLocally: "محفوظ على هذا الجهاز — ستتم مزامنته عند عودة الاتصال",
    reviewTitle: "ماذا يحدث بعد الإرسال؟",
    reviewText: "ستراجع إدارة المنصة طلبك وتتواصل معك عند اتخاذ القرار. يمكنك مغادرة هذه الصفحة والعودة لاحقاً؛ تُحفظ مسودتك تلقائياً.",
    male: "ذكر",
    female: "أنثى",
    notSelected: "—",
  },
  sq: {
    ...
    incompleteTitle: "Plotëso fushat e shënuara para se të vazhdosh",
    nextStep: "Hapi tjetër",
    previousStep: "Kthehu",
    saved: "Drafti u ruajt",
    saving: "Duke ruajtur draftin…",
    savedLocally: "U ruajt në këtë pajisje — do të sinkronizohet kur të rikthehet lidhja",
    reviewTitle: "Çfarë ndodh pas dërgimit?",
    reviewText: "Administrata e platformës do ta shqyrtojë aplikimin dhe do të të kontaktojë sapo të merret vendimi. Mund të largohesh dhe të kthehesh më vonë; drafti ruhet automatikisht.",
    male: "Mashkull",
    female: "Femër",
    notSelected: "—",
  },
