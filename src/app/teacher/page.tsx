...
.td-hero{display:block;background:linear-gradient(135deg,#09111B,#172231 68%,#31250F);border:1px solid rgba(200,169,106,.30);border-radius:18px;padding:26px;box-shadow:0 18px 40px rgba(20,14,6,.18);overflow:hidden}
...
.td-command-panel{display:block;text-decoration:none;color:#171716;background:#FFFDF8;border:1px solid rgba(184,155,94,.20);border-radius:16px;padding:16px;box-shadow:0 12px 28px rgba(42,26,10,.07)}
...
.td-command-head h2{margin:2px 0 0;font-size:18px;font-weight:900;color:#171716}
.td-groups-table{display:grid;gap:8px}
.td-group-row{display:grid;grid-template-columns:minmax(170px,1fr) repeat(3,auto);gap:14px;align-items:center;text-decoration:none;color:#171716;border:1px solid rgba(184,155,94,.16);border-radius:12px;background:#fff;padding:11px 12px;transition:.16s ease}
.td-group-row:hover{border-color:rgba(200,169,106,.55);background:#FBF6EA;transform:translateY(-1px)}
.td-group-row span:not(.td-group-name){font-size:12px;font-weight:900;color:#7D6F5A;white-space:nowrap}
...
.td-community-card{background:linear-gradient(150deg,#FFFDF8,#F7EEDC)}
...
.td-community-preview strong{display:block;font-size:13px;color:#172231}.td-community-preview p{margin:5px 0;color:#3D2E10;line-height:1.6;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.td-community-preview small{color:#7D6F5A;font-weight:900}
