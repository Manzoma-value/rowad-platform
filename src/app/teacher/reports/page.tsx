...
const TR: Record<string, Record<string, string>> = {
  ...
  sq: {
    ...
    eyebrow: "Raportet e Edukatorët",
    title: "Performanca e Pjesëmarrësve",
    pendingSuffix: "vlerësim tipari në pritje",
    noClasses: "Nuk keni grupe të caktuara ende",
    studentsLabel: "pjesëmarrës",
    attemptsLabel: "tentativa",
    avgLabel: "Mesatarja",
    pendingLabel: "Vlerësime në pritje",
    sectionStudents: "Lista e Pjesëmarrësve",
    attempt: "tentativa",
    passedLabel: "kaloi",
    traitsLabel: "tipare",
  ...
  en: {
    ...
    sectionStudents: "Beneficiary List",
    attempt: "attempt",
    passedLabel: "passed",
    traitsLabel: "traits",
