...
const UI = {
  ar: {
    ...
    searchPh: "ابحث باسم الاختبار أو المجموعة...",
    filterAll: "الكل",
    filterDraft: "مسودة",
    ...
    guide: [
      ...
      { title: "أضف الاختبار", body: "من داخل المفهوم اضغط «إضافة اختبار» واختر المجموعة." },
      { title: "أضف الأسئلة", body: "ستنتقل مباشرة لصفحة بناء الاختبار لإضافة الأسئلة." },
      { title: "أرسل للمراجعة", body: "يظهر للمستفيدين بعد اعتماد الإدارة فقط." },
    ],
  },
  sq: {
    eyebrow: "Kuizet",
    ...
    statLive: "Të dukshme",
    searchPh: "Kërko sipas emrit ose grupit...",
    filterAll: "Të gjitha",
    filterDraft: "Draft",
    ...
    guide: [
      ...
      { title: "Shto kuizin", body: "Brenda konceptit kliko «Shto kuiz» dhe zgjidh grupin." },
