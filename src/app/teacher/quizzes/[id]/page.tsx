...
const UI = {
  ar: {
    ...
    resultsSub: "تظهر النتائج بعد أن يجيب الطلاب على الاختبار.",
    noAttempts: "لم يجب أي طالب بعد.",
    ...
    guide: [
      ...
      { title: "تابع النتائج", body: "بعد الاعتماد سيجيب الطلاب، وتظهر نتائجهم في الأسفل." },
    ],
  },
  sq: {
    ...
    results: "Rezultatet e nxënësve",
    resultsSub: "Rezultatet shfaqen pasi nxënësit të përgjigjen.",
    noAttempts: "Asnjë nxënës nuk është përgjigjur ende.",
