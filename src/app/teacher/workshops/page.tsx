...
const liveCopy={ar:{live:"مباشرة الآن",liveHint:"الورشة منعقدة الآن — ادخل لمتابعة التفاصيل"},sq:{live:"Drejtpërdrejt",liveHint:"Punëtoria po zhvillohet tani — hap detajet"}} as const;
