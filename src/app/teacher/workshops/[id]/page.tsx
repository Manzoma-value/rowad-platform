...
const text = {
  ar: {
    ...
    requestSub: "أرسل طلب انضمام، وسيراجعه مسؤول المدرسة. ستُفتح كل الملفات والملاحظات والروابط فور الموافقة.",
    requestBtn: "طلب الانضمام",
    requesting: "جارٍ الإرسال...",
    requestErr: "تعذّر إرسال الطلب. حاول مرة أخرى.",
    pendingTitle: "طلبك قيد المراجعة",
    pendingSub: "أرسلنا طلبك إلى مسؤول المدرسة. ستصلك رسالة فور اتخاذ القرار.",
    waitlistedTitle: "أنت على قائمة الانتظار",
    waitlistedSub: "أضافك مسؤول المدرسة إلى قائمة الانتظار لهذه الورشة. سنخبرك عند توفر مكان.",
  ...
  sq: {
    ...
    requestSub: "Dërgo një kërkesë; administrata e shkollës do ta shqyrtojë. Të gjitha materialet hapen menjëherë pas miratimit.",
    ...
    pendingSub: "Kërkesa u dërgua te administrata e shkollës. Do të njoftohesh sapo të merret vendimi.",
