...
const T = {
  ar: {
    ...
    publishOn: "منشور للمستفيدين",
    publishOnSub: "المستفيدون يستطيعون رؤيته",
    publishOff: "مسودة",
    publishOffSub: "غير مرئي للمستفيدين — فعّله عندما يكون جاهزاً",
    gradedOn: "مُقيَّم",
  ...
  sq: {
    ...
    publishOnSub: "Pjesëmarrësit mund ta shohin",
    publishOff: "Draft",
    publishOffSub: "I padukshëm për pjesëmarrësit — publikoje kur është gati",
    gradedOn: "Me notë",
