...
const UI = {
  ar: {
    ...
    title: "ابنِ محتواك حسب خريطة المدرسة",
    sub: "الخريطة مقسّمة إلى مراحل، وكل مرحلة تحتوي مفاهيم. مهمتك: أن تضيف لكل مفهوم درساً واختباراً، ثم ترسلهما للمراجعة حتى يظهرا للطلاب.",
    stage: "المرحلة",
    concept: "مفهوم",
    concepts: "مفاهيم",
    open: "افتح المفهوم",
    ...
    emptySub: "تواصل مع إدارة المدرسة لإعداد المراحل والمفاهيم، وستظهر لك هنا مباشرة.",
    lessons: "درس",
    quizzes: "اختبار",
    done: "مكتمل",
    ...
    guide: [
      ...
      { title: "أرسل للمراجعة", body: "بعد الانتهاء اضغط «إرسال للمراجعة». يظهر للطلاب فقط بعد اعتماد الإدارة." },
    ],
  },
  sq: {
