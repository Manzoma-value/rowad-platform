...
const UI = {
  ar: {
    ...
    myLessonsSub: "الدرس يحتوي شرحاً (نص/صور/فيديو) وأسئلة يجيب عنها المستفيد.",
    myQuizzes: "اختباراتي على هذا المفهوم",
    myQuizzesSub: "الاختبار أسئلة فقط، بدون شرح — لقياس فهم المستفيد.",
    addLesson: "إضافة درس",
    ...
    fieldClass: "المجموعة الذي سيرى المحتوى",
    fieldDesc: "وصف مختصر (اختياري)",
    cancel: "إلغاء",
    create: "إنشاء ومتابعة",
    creating: "جارٍ الإنشاء…",
    needClass: "ليس لديك مجموعة بعد. تواصل مع الإدارة لتخصيص مجموعة لك قبل إنشاء المحتوى.",
    ...
    guide: [
      ...
      { title: "أنشئ درساً أو اختباراً", body: "اضغط «إضافة درس» أو «إضافة اختبار» واختر المجموعة المستهدف." },
      { title: "أضف المحتوى والأسئلة", body: "ستنتقل تلقائياً لصفحة البناء لإضافة الشرح والأسئلة." },
      { title: "أرسل للمراجعة", body: "اضغط «إرسال للمراجعة» — يظهر للمستفيدين بعد اعتماد الإدارة فقط." },
    ],
  },
  sq: {
