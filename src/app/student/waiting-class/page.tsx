...
const S = {
  ar: {
    headerLabel: "تعيين المنصة",
    headerTitle: "تم تعيينك في منصة!",
    desc: (name: string) => `${name ? `مرحباً ${name}، ` : ""}تم قبولك في المنصة بنجاح. الآن سيقوم مدير المنصة بمراجعة نتائجك وتعيينك في المجموعة الدراسية المناسبة قريباً.`,
    step1Title: "اختبار القبول",
    step1Sub: "مكتمل",
    step2Title: "تعيين المنصة",
    step2Sub: "مكتمل",
