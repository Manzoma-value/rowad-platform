...
:root{
  ...
  --green:#2D8A4A; --green-l:rgba(45,138,74,0.08); --green-b:rgba(45,138,74,0.3);
...
.slv-spinner{width:36px;height:36px;border:3px solid rgba(200,169,106,0.15);border-top-color:var(--gold);border-radius:50%;animation:slv-spin .7s linear infinite}
...
.slv-chip--gold{background:var(--gold-pale); color:#7A6020; border:1px solid var(--gold-border)}
...
.slv-highlight{background:linear-gradient(180deg, transparent 60%, rgba(200,169,106,0.35) 60%); padding:0 2px}

.slv-image-wrap{
  background:var(--surface); border:1px solid var(--border); border-radius:14px;
  overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.04);
}
.slv-image{width:100%; height:auto; display:block; max-height:520px; object-fit:contain; background:#F5F3EE}
...
.slv-mcq-opt.selected{border-color:var(--gold); background:var(--gold-pale); box-shadow:0 2px 8px rgba(200,169,106,0.15)}
...
.slv-submit-btn{
  ...
  transition:all .22s; box-shadow:0 2px 10px rgba(200,169,106,0.3);
}
.slv-submit-btn:hover:not(:disabled){transform:translateY(-2px); box-shadow:0 6px 20px rgba(200,169,106,0.4)}
