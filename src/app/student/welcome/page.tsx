...
const S = {
  ...
  sq: {
    bannerTitle: "Jeni caktuar në grupin tuaj!",
    bannerSub: (name: string) => `Mirë se vini, ${name}`,
    classLabel: "Grupi juaj",
    teacherLabel: "Edukatori juaj",
    classmatesLabel: "Shokët e grupit",
    classmatesCount: (n: number) => `${n} pjesëmarrës`,
    scoreLabel: "Rezultati i testit të vendosjes",
    goBtn: "Shko te grupi tani",
