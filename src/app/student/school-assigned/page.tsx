...
const S = {
  ar: {
    ...
    nextDesc: "ستجري الآن اختباراً قصيراً تعدّه منصتك لتحديد المجموعة المناسب لك. يشمل أسئلة اختيار متعدد وصح أم خطأ وأسئلة مكتوبة.",
    startBtn: "ابدأ اختبار التصنيف",
    starting: "جارٍ التحميل...",
    footerNote: "الاختبار إلزامي لتحديد مجموعةك الدراسي",
  },
  sq: {
    congrats: "Urime!",
...
export default function StudentSchoolAssignedPage() {
  ...
  useEffect(() => {
    ...
    cachedFetch<{ attempt: IntakeAttempt | null }>("/api/student/intake-result", 60_000)
