...
const S = {
  ar: {
    ...
    desc: "تم استلام إجاباتك بنجاح. سيقوم المسؤول بمراجعة اختبارك وتحديد المنصة المناسبة لك في أقرب وقت.",
    step1Title: "تقديم اختبار القبول",
    step1Sub: "تم بنجاح",
    step2Title: "مراجعة المسؤول",
    step2Sub: "قيد الانتظار...",
    step3Title: "تحديد المنصة",
    step3Sub: "قريباً",
    step4Title: "الانضمام للمجموعة الدراسي",
    step4Sub: "قريباً",
    note: "ستظهر هذه الصفحة حتى يتم تعيينك في منصة. لا حاجة لفعل أي شيء الآن.",
  },
  sq: {
