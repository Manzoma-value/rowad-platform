...
.bubble-del{position:absolute;top:8px;inset-inline-end:8px;background:rgba(26,26,26,.1);border:none;cursor:pointer;width:26px;height:26px;border-radius:50%;display:flex;align-items:center;justify-content:center;color:currentColor;opacity:0;transition:all .2s var(--ease);}
...
.composer-img-x{position:absolute;top:12px;right:12px;background:rgba(26,26,26,.6);border:none;color:#fff;width:22px;height:22px;border-radius:50%;cursor:pointer;font-size:10px;display:flex;align-items:center;justify-content:center;transition:all .15s;}
.composer-img-x:hover{background:rgba(26,26,26,.9);}
