...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .lp-btn{display:flex;align-items:center;justify-content:center;gap:9px;width:100%;padding:14px;background:var(--black);color:var(--gold);border:1px solid rgba(200,169,106,.25);border-radius:10px;font-size:15px;font-weight:800;cursor:pointer;transition:all .18s;font-family:'Cairo',sans-serif;margin-top:4px;position:relative;overflow:hidden;text-align:center;}
  ...
  .lp-email-sent-icon{width:80px;height:80px;border-radius:50%;background:rgba(200,169,106,.08);border:1px solid rgba(200,169,106,.2);display:flex;align-items:center;justify-content:center;}
