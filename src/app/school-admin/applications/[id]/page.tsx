...
const UI = {
  ar: {
    ...
    notes: "ملاحظات (اختيارية، تظهر للمشرف)",
    saving: "جاري الحفظ…",
    ...
    assignGroups: "مجموعات المشرفين (اختياري)",
    assignGroupsHint: "يمكنك إضافة المشرف إلى مجموعة أو أكثر الآن، أو تنظيمه لاحقاً من صفحة مجموعات المشرفين.",
    noTeacherGroups: "لا توجد مجموعات مشرفين بعد.",
  },
  sq: {
