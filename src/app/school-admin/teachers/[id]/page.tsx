...
type TeacherProfile = {
  ...
  vote_responses: Array<{ id: string; submitted_at: string; notes: string | null; answers: unknown; vote: { id: string; title: string } }>;
  classes: Array<{
...
const COPY = {
  ar: {
    ...
    groups: "مجتمعات المشرفين", futureVote: "التصويتات المشارك بها", evaluations: "تقييمات المستفيدين", created: "أُنشئ", updated: "حُدّث",
  ...
  sq: {
    ...
    groups: "Grupet e edukatorëve", futureVote: "Votimet e plotësuara", evaluations: "Vlerësime të pjesëmarrësve", created: "Krijuar", updated: "Përditësuar",
  ...
  en: {
    ...
    workshops: "Workshops & training", attendanceDays: "attendance days", completed: "Completed", enrolled: "Enrolled", professionalDetails: "All personal and professional information", groups: "Supervisor groups", futureVote: "Votes submitted", evaluations: "Beneficiary evaluations", created: "Created", updated: "Updated", review: "Review", attempts: "attempts", questions: "questions", content: "content items", openProfile: "Open profile",
