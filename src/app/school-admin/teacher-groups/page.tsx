...
const UI = {
  ar: {
    title: "Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ø§Ù„Ù…Ø¹Ù„Ù…ÙŠÙ†",
    sub: "Ù†Ø¸ÙÙ‘Ù… Ø§Ù„Ù…Ø¹Ù„Ù…ÙŠÙ† Ø§Ù„Ù…Ù‚Ø¨ÙˆÙ„ÙŠÙ† ÙÙŠ Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ø¹Ù…Ù„ ÙˆØªØ¯Ø±ÙŠØ¨ ÙˆÙ…Ø¬ØªÙ…Ø¹ Ø®Ø§ØµØ©.",
    create: "+ Ù…Ø¬Ù…ÙˆØ¹Ø© Ø¬Ø¯ÙŠØ¯Ø©",
    empty: "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ø¨Ø¹Ø¯. Ø£Ù†Ø´Ø¦ Ø£ÙˆÙ„ Ù…Ø¬Ù…ÙˆØ¹Ø© Ù„ØªÙ†Ø¸ÙŠÙ… Ù…Ø¹Ù„Ù…ÙŠÙƒ.",
    members: "Ø£Ø¹Ø¶Ø§Ø¡",
    pickOne: "Ø§Ø®ØªØ± Ù…Ø¬Ù…ÙˆØ¹Ø© Ù„Ø¹Ø±Ø¶ Ø£Ø¹Ø¶Ø§Ø¦Ù‡Ø§",
    rename: "ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„Ø§Ø³Ù… ÙˆØ§Ù„ÙˆØµÙ",
    name: "Ø§Ø³Ù… Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©",
    desc: "Ø§Ù„ÙˆØµÙ",
    save: "Ø­ÙØ¸",
    saving: "Ø¬Ø§Ø±Ù Ø§Ù„Ø­ÙØ¸â€¦",
    assessments: "Ù†Ù…Ø§Ø°Ø¬ Ø§Ù„Ù‚ÙŠØ§Ø³",
    deleteGroup: "Ø­Ø°Ù Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©",
    confirmDelete: "Ù‡Ù„ ØªØ±ÙŠØ¯ Ø­Ø°Ù Ù‡Ø°Ù‡ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©ØŸ Ø³ÙŠØªÙ… Ø¥Ù„ØºØ§Ø¡ Ø¹Ø¶ÙˆÙŠØ© ÙƒÙ„ Ø§Ù„Ù…Ø¹Ù„Ù…ÙŠÙ†.",
    addMembers: "+ Ø¥Ø¶Ø§ÙØ© Ø£Ø¹Ø¶Ø§Ø¡",
    searchPh: "Ø§Ø¨Ø­Ø« Ø¨Ø§Ù„Ø§Ø³Ù… Ø£Ùˆ Ø§Ù„Ø¨Ø±ÙŠØ¯â€¦",
    groupSearchPh: "Ø§Ø¨Ø­Ø« ÙÙŠ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø§Øªâ€¦",
    memberSearchPh: "Ø§Ø¨Ø­Ø« ÙÙŠ Ø£Ø¹Ø¶Ø§Ø¡ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©â€¦",
    noGroupResults: "Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ø¬Ù…ÙˆØ¹Ø§Øª Ù…Ø·Ø§Ø¨Ù‚Ø©.",
    noMemberResults: "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ø£Ø¹Ø¶Ø§Ø¡ Ù…Ø·Ø§Ø¨Ù‚ÙˆÙ† Ù„Ù„Ø¨Ø­Ø«.",
    noEligible: "Ù„Ø§ ÙŠÙˆØ¬Ø¯ Ù…Ø¹Ù„Ù…ÙˆÙ† Ù…ØªØ§Ø­ÙˆÙ† Ù„Ù„Ø¥Ø¶Ø§ÙØ©.",
    add: "Ø¥Ø¶Ø§ÙØ©",
    remove: "Ø¥Ø²Ø§Ù„Ø©",
    confirmRemove: "Ø¥Ø²Ø§Ù„Ø© Ù‡Ø°Ø§ Ø§Ù„Ù…Ø¹Ù„Ù… Ù…Ù† Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©ØŸ",
    cancel: "Ø¥Ù„ØºØ§Ø¡",
    yearsExp: "Ø³Ù†ÙˆØ§Øª Ø§Ù„Ø®Ø¨Ø±Ø©",
    spec: "Ø§Ù„ØªØ®ØµØµ",
    location: "Ø§Ù„Ù…ÙˆÙ‚Ø¹",
    close: "Ø¥ØºÙ„Ø§Ù‚",
    newGroupTitle: "Ø¥Ù†Ø´Ø§Ø¡ Ù…Ø¬Ù…ÙˆØ¹Ø© Ø¬Ø¯ÙŠØ¯Ø©",
    namePh: "Ù…Ø«Ø§Ù„: Ù…Ø¬Ù…ÙˆØ¹Ø© Ù…Ø¹Ù„Ù…ÙŠ Ø§Ù„Ù‚Ø±Ø¢Ù†",
    descPh: "ÙˆØµÙ Ø§Ø®ØªÙŠØ§Ø±ÙŠ Ù„Ù„Ù…Ø¬Ù…ÙˆØ¹Ø© ÙˆØ£Ù‡Ø¯Ø§ÙÙ‡Ø§â€¦",
    creating: "Ø¬Ø§Ø±Ù Ø§Ù„Ø¥Ù†Ø´Ø§Ø¡â€¦",
  },
  sq: {
    title: "Grupet e mÃ«suesve",
    sub: "Organizo mÃ«suesit e pranuar nÃ« grupe pune, trajnimi dhe komunitete private.",
    create: "+ Grup i ri",
    empty: "Nuk ka grupe ende. Krijo grupin e parÃ«.",
    members: "anÃ«tarÃ«",
    pickOne: "Zgjidh njÃ« grup pÃ«r tÃ« parÃ« anÃ«tarÃ«t",
    rename: "Redakto emrin dhe pÃ«rshkrimin",
    name: "Emri i grupit",
    desc: "PÃ«rshkrimi",
    save: "Ruaj",
    saving: "Po ruhetâ€¦",
    ...
    confirmDelete: "TÃ« fshihet ky grup? TÃ« gjithÃ« anÃ«tarÃ«t do hiqen.",
    addMembers: "+ Shto anÃ«tarÃ«",
    searchPh: "KÃ«rko sipas emrit ose email-itâ€¦",
    groupSearchPh: "KÃ«rko nÃ« grupeâ€¦",
    memberSearchPh: "KÃ«rko nÃ« anÃ«tarÃ«t e grupitâ€¦",
    noGroupResults: "Nuk ka grupe qÃ« pÃ«rputhen.",
    noMemberResults: "Nuk ka anÃ«tarÃ« qÃ« pÃ«rputhen.",
    noEligible: "Nuk ka mÃ«sues tÃ« disponueshÃ«m.",
    add: "Shto",
    remove: "Hiq",
    confirmRemove: "TÃ« hiqet ky mÃ«sues nga grupi?",
    cancel: "Anulo",
    yearsExp: "Vitet e pÃ«rvojÃ«s",
    spec: "Specializimi",
    location: "Vendndodhja",
    close: "Mbyll",
    newGroupTitle: "Krijo grup tÃ« ri",
    namePh: "Shembull: MÃ«suesit e Kuranit",
    descPh: "PÃ«rshkrim opsionalâ€¦",
...
export default function TeacherGroupsPage() {
  ...
  const A = {
    announcements: L === "ar" ? "Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©" : "Njoftimet e grupit",
    announcementPh: L === "ar"
      ? "Ø§ÙƒØªØ¨ Ø¥Ø¹Ù„Ø§Ù†Ø§Ù‹ Ø£Ùˆ ØªØ¹Ù„ÙŠÙ‚Ø§Ù‹ Ù„Ù‡Ø°Ù‡ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø©..."
      : "Shkruaj njÃ« njoftim ose koment pÃ«r kÃ«tÃ« grup...",
    post: L === "ar" ? "Ù†Ø´Ø±" : "Posto",
    posting: L === "ar" ? "Ø¬Ø§Ø±ÙŠ Ø§Ù„Ù†Ø´Ø±..." : "Duke postuar...",
    noAnnouncements: L === "ar"
      ? "Ù„Ù… ØªØªÙ… Ø¥Ø¶Ø§ÙØ© Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Ù„Ù‡Ø°Ù‡ Ø§Ù„Ù…Ø¬Ù…ÙˆØ¹Ø© Ø¨Ø¹Ø¯."
      : "Nuk ka njoftime pÃ«r kÃ«tÃ« grup ende.",
    delete: L === "ar" ? "Ø­Ø°Ù" : "Fshi",
  };
  ...
  // â”€â”€ eligible-teacher fetch (debounced)
  useEffect(() => {
  ...
  return (
    <div className="tg" dir={dir}>
          ...
          {!selectedId ? (
            ...
            <>
              ...
              <div className="tg-members">
                {detail.members.length === 0 ? (
                  <div className="tg-members-empty">â€”</div>
                      ...
                      {m.teacher.application && (
                        <div className="tg-member-meta">
                          ...
                          {(m.teacher.application.country || m.teacher.application.city) && (
                            <span>{T.location}: <strong>{m.teacher.application.country}{m.teacher.application.city ? " Â· " + m.teacher.application.city : ""}</strong></span>
                          )}
                        </div>
                      )}
                    </div>
                    {!viewOnly && (
                      <button className="tg-mini-x" onClick={() => removeMember(m.teacher.id)} data-write="true" title={T.remove}>Ã—</button>
                    )}
                  </div>
                ))}
              </div>
        ...
        <div className="tg-overlay" onClick={() => setAddOpen(false)}>
          <div className="tg-dialog tg-dialog-wide" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="tg-eligible">
              {loadingEligible ? <div className="tg-mini-load">â€¦</div>
                    ...
                    >
                      ...
                      {t.application && (
                        <div className="tg-elig-meta">
                          ...
                          {t.application.country && <span>Â· {t.application.country}{t.application.city ? " Â· " + t.application.city : ""}</span>}
                        </div>
                      )}
                      <span className="tg-elig-tick">{on ? "âœ“" : "+"}</span>
                    </button>
                  );
                })}
            </div>
      ...
      <style>{`
        ...
        .tg-new { background: linear-gradient(180deg,#4A0E1C,#12070B); color: #D9C9B0; border: none; padding: 10px 18px; border-radius: 11px; font-family: inherit; font-size: 13.5px; font-weight: 800; cursor: pointer; }

        .tg-layout { display: grid; grid-template-columns: 320px 1fr; gap: 16px; }
        @media (max-width: 880px) { .tg-layout { grid-template-columns: 1fr; } }

        .tg-side { background: #FBF8F1; border: 1px solid rgba(74,14,28,0.07); border-radius: 14px; padding: 10px; min-height: 200px; }
        ...
        .tg-side-search:focus, .tg-member-filter input:focus { border-color: #8F765B; box-shadow: 0 0 0 3px rgba(194,160,89,0.10); }
        ...
        .tg-list-item.active { background: linear-gradient(165deg,#FCF6E6,#F4EBD3); border-color: #8F765B; }
        .tg-list-name { font-size: 13.5px; font-weight: 800; color: #1B1810; }
        .tg-list-meta { font-size: 11.5px; color: #8B6915; font-weight: 700; }

        .tg-detail { background: #FBF8F1; border: 1px solid rgba(74,14,28,0.07); border-radius: 14px; padding: 18px; min-height: 320px; }
        .tg-detail-empty { padding: 60px 20px; text-align: center; color: #8A8478; font-weight: 700; }
        .tg-detail-head { padding-bottom: 14px; border-bottom: 1px solid rgba(74,14,28,0.07); margin-bottom: 14px; display: flex; flex-direction: column; gap: 8px; }
        ...
        .tg-btn-primary { background: linear-gradient(180deg,#4A0E1C,#12070B); color: #D9C9B0; border-color: transparent; }
        ...
        .tg-member { display: flex; align-items: flex-start; gap: 10px; padding: 12px 14px; border: 1px solid rgba(194,160,89,0.25); border-radius: 11px; background: linear-gradient(165deg,#FFFFFF,#FBF8F1); }
        ...
        .tg-ann-section { margin-top: 18px; padding-top: 16px; border-top: 1px solid rgba(74,14,28,0.07); }
        ...
        .tg-ann-composer textarea:focus { border-color: #8F765B; box-shadow: 0 0 0 3px rgba(194,160,89,0.08); }
        .tg-ann-composer button { align-self: flex-end; border: 0; border-radius: 10px; padding: 8px 16px; background: #1A1A1A; color: #D9C9B0; font-family: inherit; font-size: 12.5px; font-weight: 900; cursor: pointer; }
        ...
        .tg-overlay { position: fixed; inset: 0; background: rgba(74,14,28,0.55); display: flex; align-items: center; justify-content: center; z-index: 100; padding: 20px; backdrop-filter: blur(4px); }
        .tg-dialog { background: #FBF8F1; border-radius: 16px; padding: 22px; max-width: 460px; width: 100%; box-shadow: 0 20px 60px rgba(0,0,0,0.3); }
        ...
        .tg-input:focus { border-color: #8F765B; }
        ...
        .tg-elig:hover { border-color: #8F765B; }
        .tg-elig.on { background: linear-gradient(165deg,#FCF6E6,#F4EBD3); border-color: #8F765B; }
        ...
        .tg-elig-tick { position: absolute; inset-inline-end: 12px; top: 50%; transform: translateY(-50%); width: 22px; height: 22px; border-radius: 50%; background: #8F765B; color: #1E1605; display: flex; align-items: center; justify-content: center; font-weight: 900; font-size: 12.5px; }
