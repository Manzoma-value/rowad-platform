...
const UI = {
  ar: {
    ...
    signupSub: "هذا الرمز ثابت. اعرضه في الورشة ليُنشئ المشرف حسابه ثم يكمل نموذج التقديم.",
    attendanceQr: "QR الحضور الدائم",
    attendanceSub: "رمز واحد ثابت لكل أيام الورشة. عند المسح، يسجل النظام حضور المشرف تلقائياً في تاريخ اليوم.",
    ...
    total: "الإجمالي",
    status: "الحالة",
    noTeachers: "لا يوجد مشرفون مرتبطون بهذه الورشة بعد. سيظهر هنا كل من سجّل عبر QR التسجيل أو سجّل حضوراً.",
    present: "حاضر",
    registered: "مسجلون",
    days: "أيام",
    refresh: "تحديث",
    error: "تعذر تحميل بيانات الورشة.",
    schedule: "البرنامج الزمني", workDay: "يوم تدريب", restDay: "إجازة / راحة", content: "محتوى الورشة", contentHelp: "الملفات والروابط التي ستتاح للمشرفين بعد تسجيل حضورهم.", notes: "رسالة الإدارة المثبتة", addFile: "رفع ملف", addLink: "إضافة رابط", linkTitle: "عنوان المحتوى", linkUrl: "رابط YouTube أو Drive أو أي رابط آمن", add: "إضافة", noContent: "لم تتم إضافة محتوى بعد.", remove: "حذف", exportExcel: "Excel", exportPdf: "PDF", exporting: "جاري التصدير...", discussion: "ملاحظات الورشة المشتركة", discussionHelp: "اكتب رسالة أو ملاحظة تظهر لجميع المشرفين الحاضرين. رسائل الإدارة تظهر بشكل مميز.", messagePlaceholder: "اكتب رسالة للحاضرين...", publish: "نشر", publishing: "جاري النشر...", noMessages: "لا توجد ملاحظات مشتركة بعد.", adminBadge: "الإدارة", teacherBadge: "مشرف", messageError: "تعذر نشر الرسالة.", materialError: "تعذر حفظ المادة. تأكد أن الملف أقل من 40MB ثم حاول مرة أخرى.",
  },
  sq: {
    back: "Kthehu te forumet",
    signupQr: "QR i regjistrimit",
    signupSub: "Ky kod është i përhershëm. Shfaqe në forum që edukatori të krijojë llogarinë dhe të plotësojë aplikimin.",
...
const OPS = {
  ...
  sq: {
    ...
    participantsSub: "Shto çdo edukator aktiv pa skanuar kodin QR.",
    searchTeachers: "Kërko me emër ose email",
    activeTeachers: "Edukatorët aktivë",
    enrolled: "I shtuar",
    enrolledCount: "Të shtuar",
    availableCount: "Të disponueshëm",
    addTeacher: "Shto në forum",
    adding: "Duke shtuar...",
    noActiveTeachers: "Nuk ka edukatorë aktivë që përputhen.",
    tabRequests: "Kërkesat për t'u bashkuar",
    tabRoster: "Të gjithë edukatorët",
