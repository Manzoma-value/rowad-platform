...
.wd-hero{display:flex;justify-content:space-between;gap:18px;align-items:flex-start;flex-wrap:wrap;background:linear-gradient(135deg,#10151B,#2E2414);border:1px solid rgba(200,169,106,.26);border-radius:18px;padding:24px;margin-bottom:14px;box-shadow:0 18px 44px rgba(30,20,8,.16)}
...
.wd-dates{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}.wd-dates span{border:1px solid rgba(200,169,106,.18);background:rgba(255,255,255,.06);border-radius:10px;padding:6px 10px;color:#E8DCBC;font-size:12px;font-weight:800}
.wd-hero-btn,.wd-small-btn,.wd-copy{border:0;border-radius:11px;background:#0B0B0C;color:#E5B93C;padding:10px 15px;font:inherit;font-weight:900;cursor:pointer}
...
.wd-stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-bottom:14px}.wd-stats div{background:#FFFDF8;border:1px solid rgba(184,155,94,.18);border-radius:14px;padding:14px;box-shadow:0 10px 24px rgba(42,26,10,.06)}.wd-stats span{display:block;color:#8E7243;font-size:12px;font-weight:900}.wd-stats strong{display:block;margin-top:7px;font-size:30px;line-height:1;color:#1B1810}
.wd-qr-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-bottom:14px}.wd-card{background:#FFFDF8;border:1px solid rgba(184,155,94,.20);border-radius:16px;padding:16px;box-shadow:0 12px 28px rgba(42,26,10,.07)}.wd-card-head,.wd-table-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid rgba(184,155,94,.14)}.wd-card h2,.wd-table-head h2{margin:0 0 4px;font-size:18px;font-weight:900}.wd-card p,.wd-table-head p{margin:0;color:#5E5A52;font-size:13px;line-height:1.75}
...
.wd-empty{padding:40px 20px;text-align:center;border:1px dashed rgba(184,155,94,.34);border-radius:14px;color:#8A8478;font-weight:800;background:#FFFDF8}.wd-table-wrap{overflow:auto;border:1px solid rgba(8,11,12,.08);border-radius:13px}.wd-table{width:100%;border-collapse:collapse;min-width:860px;background:#fff}.wd-table th{background:#F6F0E6;color:#6B4F1E;font-size:11px;font-weight:900;padding:10px;border-bottom:1px solid rgba(184,155,94,.22);white-space:nowrap}.wd-table td{padding:10px;border-bottom:1px solid rgba(8,11,12,.06);text-align:center;font-size:12.5px;color:#2E2210}.wd-table tr:last-child td{border-bottom:0}.wd-teacher{text-align:start!important;font-weight:900;color:#1B1810!important}.wd-total{font-weight:900;color:#1B1810!important}.wd-table td.present{background:rgba(76,107,60,.14);color:#3E642E;font-weight:900}.wd-table td.absent{background:rgba(163,59,46,.10);color:#9A3025;font-weight:900}
