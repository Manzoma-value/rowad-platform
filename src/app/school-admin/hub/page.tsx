...
:root{
  ...
  --gold:#B8A082;--gold2:#D4B87A;--gold3:#E0C98A;--gold4:#B8A082;
  ...
  --admin-mine-bg:linear-gradient(135deg,#D4B87A,#B8A082);--admin-mine-border:rgba(184,160,130,.45);
...
.mode-bar-admin{background:linear-gradient(90deg,rgba(184,160,130,.16),rgba(184,160,130,.12));border-bottom:1px solid rgba(184,160,130,.25);color:var(--gold4);}
...
.reply-send-btn{background:var(--graphite);border:none;color:#F7F3EB;width:36px;height:36px;border-radius:50%;cursor:pointer;flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:all .2s var(--ease-b);}
...
.chip-admin{color:var(--gold4);background:rgba(184,160,130,.12);border-color:rgba(184,160,130,.38);}
...
.av-admin-self{box-shadow:0 2px 8px rgba(0,0,0,.15),0 0 0 2px rgba(184,160,130,.5),0 0 0 3.5px rgba(184,160,130,.25);}
...
.composer-send-btn{background:var(--graphite);border:none;color:#F7F3EB;width:42px;height:42px;border-radius:50%;cursor:pointer;flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:all .22s var(--ease-b);box-shadow:0 3px 16px rgba(11,11,12,.25);}
...
.s-light{border-color:rgba(247,237,216,.2);border-top-color:#F7F3EB;}
...
.mode-bar-admin{color:#7A5B16;background:linear-gradient(90deg,rgba(255,253,248,.86),rgba(184,160,130,.16));}
...
.chat-bubble-mine{background:linear-gradient(145deg,#D8B777,#B8A082);box-shadow:0 10px 24px rgba(157,116,44,.22);}
.chat-bubble-admin-mine{background:linear-gradient(135deg,#D4B87A,#F0CE70);box-shadow:0 10px 26px rgba(157,116,44,.26);}
...
.hub-header{background:linear-gradient(135deg,rgba(15,16,18,.98),rgba(45,35,20,.96));border-bottom:1px solid rgba(184,160,130,.22);box-shadow:0 18px 46px rgba(17,17,18,.28);}
.hub-header-stripe{height:3px;background:linear-gradient(90deg,transparent 0%,#B8A082 16%,#F0CE70 48%,#B8A082 82%,transparent 100%);}
...
.chat-bubble-mine{background:linear-gradient(135deg,#F0CD72 0%,#B8A082 100%);border:1px solid rgba(122,84,18,.12);box-shadow:0 14px 30px rgba(157,116,44,.22);}
.chat-bubble-admin-mine{background:linear-gradient(135deg,#F6D87C 0%,#B8A082 100%);box-shadow:0 16px 34px rgba(157,116,44,.26);}
...
.composer-send-btn{background:linear-gradient(135deg,#32101A,#3D2D14);box-shadow:0 10px 22px rgba(28,20,8,.22);}
@media(max-width:640px){
