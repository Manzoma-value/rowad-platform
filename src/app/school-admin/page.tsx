...
const styles = `
  ...
  .ad-page{font-family:'Cairo',sans-serif;display:flex;flex-direction:column;gap:18px;color:var(--sa-charcoal,#1A1A1A);animation:rise .35s ease both}
  .ad-error{padding:40px;text-align:center;color:var(--sa-graphite-soft,#8C8274);font-family:'Cairo',sans-serif}
  .ad-hero{position:relative;overflow:hidden;border-radius:28px;padding:30px;display:grid;grid-template-columns:minmax(0,1fr) 260px;gap:22px;align-items:end;background:radial-gradient(circle at 12% 12%,rgba(217,201,176,.18),transparent 30%),linear-gradient(135deg,#1A1A1A,#4A0E1C 58%,#6B1E2D);border:1px solid rgba(217,201,176,.25);box-shadow:0 18px 50px rgba(74,14,28,.16)}
  .ad-hero:after{content:"";position:absolute;inset-inline-end:-120px;top:-140px;width:360px;height:360px;border-radius:999px;border:1px solid rgba(217,201,176,.16);box-shadow:inset 0 0 80px rgba(217,201,176,.08)}
  .ad-hero-copy,.ad-hero-side{position:relative;z-index:1}.ad-hero-copy span{display:block;color:#D9C9B0;font-size:11px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.ad-hero h1{margin:7px 0 8px;color:#EFEAE0;font-size:34px;font-weight:900;letter-spacing:-.6px}.ad-hero p{max-width:720px;margin:0;color:rgba(239,234,224,.74);font-size:14px;line-height:1.8}.ad-hero-side{padding:18px;border-radius:20px;background:rgba(239,234,224,.08);border:1px solid rgba(217,201,176,.22);backdrop-filter:blur(10px)}.ad-hero-side strong{display:block;color:#D9C9B0;font-size:13px}.ad-hero-side span{display:block;margin-top:6px;color:#EFEAE0;font-size:18px;font-weight:900}
  .ad-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.ad-kpi{position:relative;overflow:hidden;min-height:128px;border-radius:22px;padding:18px;background:var(--sa-bg-card,#FBF8F1);border:1px solid rgba(184,160,130,.22);text-decoration:none;color:var(--sa-charcoal,#1A1A1A);box-shadow:0 10px 28px rgba(74,14,28,.055);transition:.2s ease}.ad-kpi:hover{transform:translateY(-3px);border-color:rgba(107,30,45,.28);box-shadow:0 16px 34px rgba(74,14,28,.09)}.ad-kpi:before{content:"";position:absolute;inset-inline-end:-34px;bottom:-42px;width:120px;height:120px;border-radius:999px;background:rgba(184,160,130,.16)}.ad-kpi span{display:block;color:#5D554A;font-size:12px;font-weight:900}.ad-kpi strong{display:block;margin-top:14px;font-size:38px;line-height:1;font-weight:900}.ad-kpi em{position:absolute;bottom:16px;inset-inline-start:18px;color:#6B1E2D;font-size:11px;font-style:normal;font-weight:900}.ad-kpi.red:before{background:rgba(107,30,45,.12)}.ad-kpi.blue:before{background:rgba(184,160,130,.18)}.ad-kpi.green:before{background:rgba(27,94,32,.10)}
  .ad-grid{display:grid;grid-template-columns:1fr 1.2fr;gap:14px}.ad-panel{border-radius:24px;background:var(--sa-bg-card,#FBF8F1);border:1px solid rgba(184,160,130,.20);padding:18px;box-shadow:0 10px 28px rgba(74,14,28,.045)}.ad-panel-head{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:13px}.ad-panel-head h2{margin:0;font-size:16px;font-weight:900}.ad-panel-head span{padding:4px 10px;border-radius:999px;background:rgba(184,160,130,.14);color:#6B1E2D;font-size:11px;font-weight:900}.ad-priority{display:flex;justify-content:space-between;gap:12px;padding:13px 14px;border-radius:16px;text-decoration:none;background:rgba(184,160,130,.11);border:1px solid rgba(184,160,130,.24);color:#4A0E1C;margin-top:9px}.ad-priority.red{background:rgba(107,30,45,.07);border-color:rgba(107,30,45,.18);color:#6B1E2D}.ad-priority strong{font-size:12.5px}.ad-priority span{font-size:12px;font-weight:900}.ad-calm{margin:0;padding:22px;border-radius:18px;background:rgba(27,94,32,.07);color:#1B5E20;font-size:13px;font-weight:900;text-align:center}.ad-status-row{display:flex;flex-direction:column;gap:7px;margin-top:10px}.ad-status-row>div:first-child{display:flex;justify-content:space-between;gap:12px;color:#1A1A1A;font-size:12px;font-weight:900}.ad-status-row span{color:#5D554A}.ad-track{height:8px;border-radius:99px;background:#E5E0D5;overflow:hidden}.ad-track i{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#6B1E2D,#B8A082)}
  .ad-modules{display:flex;flex-direction:column;gap:12px}.ad-section-title h2{margin:0;font-size:18px;font-weight:900}.ad-module-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.ad-module{min-height:220px;border-radius:24px;padding:18px;background:linear-gradient(180deg,#FBF8F1,#E5E0D5);border:1px solid rgba(184,160,130,.22);box-shadow:0 10px 28px rgba(74,14,28,.045)}.ad-module h3{margin:0;color:#1A1A1A;font-size:16px;font-weight:900}.ad-module p{margin:8px 0 16px;color:#5D554A;font-size:12.5px;line-height:1.75;font-weight:700}.ad-module div{display:flex;flex-wrap:wrap;gap:8px;margin-top:auto}.ad-module a{display:inline-flex;padding:8px 10px;border-radius:999px;text-decoration:none;background:#4A0E1C;color:#D9C9B0;font-size:11px;font-weight:900;border:1px solid rgba(217,201,176,.20)}
