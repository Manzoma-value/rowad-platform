...
const styles = `
  ...
  .ad-page{font-family:'Cairo',sans-serif;display:flex;flex-direction:column;gap:18px;color:#1A1A1A;animation:rise .35s ease both}
  .ad-error{padding:40px;text-align:center;color:#796A62;font-family:'Cairo',sans-serif}
  ...
  .ad-hero:after{content:"";position:absolute;inset-inline-end:-120px;top:-140px;width:360px;height:360px;border-radius:999px;border:1px solid rgba(184,160,130,.16);box-shadow:inset 0 0 80px rgba(184,160,130,.08)}
  .ad-hero-copy,.ad-hero-side{position:relative;z-index:1}.ad-hero-copy span{display:block;color:#D9C9B0;font-size:11px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.ad-hero h1{margin:7px 0 8px;color:#fff;font-size:34px;font-weight:900;letter-spacing:-.6px}.ad-hero p{max-width:720px;margin:0;color:rgba(255,255,255,.72);font-size:14px;line-height:1.8}.ad-hero-side{padding:18px;border-radius:20px;background:rgba(255,255,255,.07);border:1px solid rgba(184,160,130,.18);backdrop-filter:blur(10px)}.ad-hero-side strong{display:block;color:#B8A082;font-size:13px}.ad-hero-side span{display:block;margin-top:6px;color:#fff;font-size:18px;font-weight:900}
  .ad-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.ad-kpi{position:relative;overflow:hidden;min-height:128px;border-radius:22px;padding:18px;background:linear-gradient(180deg,#FBF8F1,#F1EBDD);border:1px solid rgba(184,160,130,.26);text-decoration:none;color:#1A1A1A;box-shadow:0 10px 28px rgba(74,14,28,.045);transition:.2s ease}.ad-kpi:hover{transform:translateY(-3px);border-color:rgba(107,30,45,.25);box-shadow:0 16px 34px rgba(74,14,28,.08)}.ad-kpi:before{content:"";position:absolute;inset-inline-start:0;top:0;bottom:0;width:4px;background:linear-gradient(180deg,#6B1E2D,#B8A082)}.ad-kpi span{display:block;color:#7B6B52;font-size:12px;font-weight:900}.ad-kpi strong{display:block;margin-top:14px;font-size:38px;line-height:1;font-weight:900}.ad-kpi em{position:absolute;bottom:16px;inset-inline-start:18px;color:#6B1E2D;font-size:11px;font-style:normal;font-weight:900}.ad-kpi.alert:before{background:#6B1E2D}
  .ad-grid{display:grid;grid-template-columns:1fr 1.2fr;gap:14px}.ad-panel{border-radius:24px;background:#FFFBF5;border:1px solid rgba(184,160,130,.16);padding:18px;box-shadow:0 10px 28px rgba(26,26,26,.045)}.ad-panel-head{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:13px}.ad-panel-head h2{margin:0;font-size:16px;font-weight:900}.ad-panel-head span{padding:4px 10px;border-radius:999px;background:rgba(184,160,130,.14);color:#6B1E2D;font-size:11px;font-weight:900}.ad-priority{display:flex;justify-content:space-between;gap:12px;padding:13px 14px;border-radius:16px;text-decoration:none;background:rgba(184,160,130,.10);border:1px solid rgba(184,160,130,.20);color:#4B3511;margin-top:9px}.ad-priority.red{background:rgba(107,30,45,.06);border-color:rgba(107,30,45,.18);color:#6B1E2D}.ad-priority strong{font-size:12.5px}.ad-priority span{font-size:12px;font-weight:900}.ad-calm{margin:0;padding:22px;border-radius:18px;background:rgba(184,160,130,.10);color:#4A0E1C;font-size:13px;font-weight:900;text-align:center}.ad-status-row{display:flex;flex-direction:column;gap:7px;margin-top:10px}.ad-status-row>div:first-child{display:flex;justify-content:space-between;gap:12px;color:#3D3526;font-size:12px;font-weight:900}.ad-status-row span{color:#796A62}.ad-track{height:8px;border-radius:99px;background:#EFE6D4;overflow:hidden}.ad-track i{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#6B1E2D,#B8A082)}
  .ad-modules{display:flex;flex-direction:column;gap:12px}.ad-section-title h2{margin:0;font-size:18px;font-weight:900}.ad-module-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.ad-module{min-height:220px;border-radius:24px;padding:18px;background:linear-gradient(180deg,#FFFBF5,#F8F1E5);border:1px solid rgba(184,160,130,.17);box-shadow:0 10px 28px rgba(26,26,26,.045)}.ad-module h3{margin:0;color:#1A1A1A;font-size:16px;font-weight:900}.ad-module p{margin:8px 0 16px;color:#7D6E55;font-size:12.5px;line-height:1.75;font-weight:700}.ad-module div{display:flex;flex-wrap:wrap;gap:8px;margin-top:auto}.ad-module a{display:inline-flex;padding:8px 10px;border-radius:999px;text-decoration:none;background:#0B1118;color:#D9C9B0;font-size:11px;font-weight:900;border:1px solid rgba(184,160,130,.18)}
