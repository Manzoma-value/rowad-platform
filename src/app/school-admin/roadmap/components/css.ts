...
:root {
  --gold: #D9C9B0;
  --gold2: #B8A082;
  --gold-l: rgba(217,201,176,0.08);
  --gold-b: rgba(217,201,176,0.22);
...
@keyframes glowPulse { 0%,100% { box-shadow: 0 0 20px rgba(217,201,176,0.1); } 50% { box-shadow: 0 0 35px rgba(217,201,176,0.2); } }
...
.rb-header::before {
  ...
  background: linear-gradient(90deg, transparent, #B8A082 30%, #D9C9B0 60%, transparent);
}
.rb-header::after {
...
.rb-stage-badge {
  ...
  font-size: 14px; font-weight: 900; box-shadow: 0 2px 8px rgba(217,201,176,0.3);
}
...
.rb-content-type-badge.IMAGE { background: linear-gradient(135deg, rgba(184,160,130,0.12), rgba(184,160,130,0.06)); color: #7A6020; border: 1px solid var(--gold-b); }
...
.rb-add-content-pill:hover {
  border-color: var(--gold); background: rgba(217,201,176,0.14);
  transform: translateY(-1px); box-shadow: 0 3px 12px rgba(217,201,176,0.15);
}
...
.rb-add-q-btn:hover { border-color: var(--gold); background: rgba(217,201,176,0.12); transform: translateY(-1px); }
...
.rb-btn-primary {
  ...
  box-shadow: 0 2px 8px rgba(217,201,176,0.25);
}
.rb-btn-primary:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(217,201,176,0.35); }
...
/* â”€â”€â”€ TYPE BTNS (question type selector) â”€â”€â”€ */
...
.rb-tf-btn.true { background: var(--gold-l); color: #7A6020; border-color: var(--gold); box-shadow: 0 2px 10px rgba(217,201,176,0.12); }
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   IMAGE UPLOAD ZONE â€” Premium design
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
.rb-upload-zone {
...
.rb-upload-zone::before {
  ...
  background: radial-gradient(circle at center, rgba(217,201,176,0.06), transparent 70%);
  opacity: 0; transition: opacity .3s;
}
.rb-upload-zone:hover {
  border-color: var(--gold); background: rgba(217,201,176,0.06);
  transform: translateY(-2px); box-shadow: 0 8px 30px rgba(217,201,176,0.1);
}
...
.rb-empty-glow {
  ...
  background: radial-gradient(circle, rgba(217,201,176,.1) 0%, transparent 70%);
