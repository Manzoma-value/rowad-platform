...
const UI = {
  ar: {
    ...
    sub: "راجع الدروس والاختبارات التي قدمها المشرفون قبل أن تصل للمستفيدين. يمكنك الموافقة أو الرفض مع كتابة ملاحظات.",
    ...
    notesPh: "اكتب ملاحظاتك للمشرف (اختياري)…",
    cancel: "إلغاء",
    submit: "تأكيد",
    saving: "جارٍ الحفظ…",
  ...
  sq: {
    ...
    sub: "Shqyrto mësimet dhe kuizet që edukatorët kanë dërguar para se t'i shohin pjesëmarrësit. Mund të miratosh ose refuzosh me shënime.",
    ...
    notesPh: "Shkruaj shënime për edukatorin (opsionale)…",
    cancel: "Anulo",
    submit: "Konfirmo",
    saving: "Po ruhet…",
