...
const copy = {
  ar: {
    ...
    sub: "حدد الجمهور الذي تستقبله المنصة الآن. ينعكس التغيير فورًا على صفحة المنصة العامة.",
    live: "المسار المنشور حاليًا",
    teacher: "مسار المشرفين",
    teacherSub: "تظهر بوابة تسجيل الدخول فقط، من دون إنشاء حساب عام.",
    student: "مسار المستفيدين",
    studentSub: "تظهر خيارات تسجيل الدخول وإنشاء حساب المستفيد.",
    teacherNote: "التسجيل العام مغلق. تبقى دعوات المشرفين وروابط الورش فعالة.",
    studentNote: "التسجيل العام متاح للمستفيدين الجدد من صفحة المنصة.",
    save: "نشر المسار",
    saving: "جارٍ النشر...",
  ...
  sq: {
    ...
    teacher: "Rrjedha e edukatorëve",
    teacherSub: "Shfaqet vetëm hyrja, pa regjistrim publik.",
    student: "Rrjedha e pjesëmarrësve",
    studentSub: "Shfaqen hyrja dhe krijimi i llogarisë së pjesëmarrësit.",
    teacherNote: "Regjistrimi publik është mbyllur. Ftesat dhe lidhjet e forumeve mbeten aktive.",
    studentNote: "Regjistrimi publik është i hapur për pjesëmarrësit e rinj.",
  ...
  en: {
    ...
    sub: "Choose the audience the platform is welcoming now. Changes appear immediately on the public platform page.",
    live: "Currently published flow",
    teacher: "Supervisor flow",
    teacherSub: "Shows the login portal only, with no public account creation.",
    student: "Beneficiary flow",
    studentSub: "Shows beneficiary login and account creation options.",
    teacherNote: "Public signup is closed. Supervisor invitations and workshop links remain active.",
    studentNote: "Public signup is available to new beneficiaries from the platform page.",
    save: "Publish flow",
    saving: "Publishing...",
