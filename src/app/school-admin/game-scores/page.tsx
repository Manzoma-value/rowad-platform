...
const UI = {
  ...
  sq: {
    ...
    inProgressSectionSub: "Edukatorë dhe pjesëmarrës që kanë filluar kartën e modelit dhe s'e kanë dërguar ende — progresi i tyre ruhet automatikisht derisa të kthehen ta përfundojnë.",
    ...
    filterStudents: "Vetëm pjesëmarrësit",
    ...
    roleTEACHER: "Edukator",
    roleSTUDENT: "Pjesëmarrës",
    backToList: "← Kthehu",
