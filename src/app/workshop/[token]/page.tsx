...
const UI = {
  ar: {
    ...
    err_not_teacher: "هذا الحساب ليس حساب مشرف. سجّل الدخول بحساب مشرف للانضمام إلى الورشة.",
    err_account_inactive: "حساب المشرف معطّل حالياً. تواصل مع إدارة المنصة.",
    err_school_mismatch: "حسابك مرتبط بمنصة أخرى ولا يمكن ربطه بهذه الورشة.",
  ...
  sq: {
    ...
    err_not_teacher: "Kjo nuk është llogari edukatori. Hyni me një llogari edukatori.",
    err_account_inactive: "Llogaria e edukatorit është çaktivizuar. Kontaktoni administratën.",
    err_school_mismatch: "Llogaria juaj i përket një platforme tjetër dhe nuk mund të lidhet me këtë forum.",
