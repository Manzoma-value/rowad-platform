        ...
        {sent ? (
          <div className="fp-card fp-card--sent">
            <div className="fp-sent-icon">
              <svg width="48" height="48" fill="none" viewBox="0 0 24 24" stroke="#C8A96A" strokeWidth={1.4}>
...
.fp-nav{height:56px;padding:0 24px;display:flex;align-items:center;background:rgba(245,243,238,0.92);backdrop-filter:blur(14px);border-bottom:1px solid rgba(200,169,106,0.12)}
...
.fp-card--sent{
  ...
  box-shadow:0 6px 32px rgba(200,169,106,0.1);
...
.fp-btn--dark{background:var(--black);color:var(--gold);border-color:rgba(200,169,106,0.25);width:100%}
.fp-btn--dark:hover:not(:disabled){background:#1a1a1e;border-color:rgba(200,169,106,0.5);color:var(--gold2)}
...
.fp-btn--gold:hover{transform:translateY(-1px);box-shadow:0 4px 16px rgba(200,169,106,0.35)}

.fp-spin{display:inline-block;width:13px;height:13px;border:2px solid rgba(200,169,106,0.25);border-top-color:var(--gold);border-radius:50%;animation:fp-spin 0.65s linear infinite;flex-shrink:0}

/* Sent screen */
.fp-sent-icon{width:72px;height:72px;border-radius:50%;background:rgba(200,169,106,0.08);border:1.5px solid rgba(200,169,106,0.2);display:flex;align-items:center;justify-content:center;margin-bottom:4px}
