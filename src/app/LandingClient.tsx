...
const T = {
  ar: {
    dir: "rtl" as const,
    brand: "منصة رواد",
    eyebrow: "منصة مدرسية بيضاء قابلة للتخصيص",
    headline: "منصة واحدة تعرض تجربة أي مدرسة بثقة",
    sub: "واجهة عامة لرواد تعرض للمدارس والمستثمرين دورة تشغيل كاملة: مالك عام، إدارة مدرسة، مشرفون، مستفيدون، محتوى، قياس، تقارير، ومجتمع، مع فصل بيانات كل مدرسة عن الأخرى.",
    ctaJoin: "دخول المالك أو الإدارة",
    ctaExplore: "استعراض المنصة",
    loginBtn: "تسجيل الدخول",
    signupBtn: "حساب مستفيد",
    navAbout: "المنصة",
    navDims: "البوابات",
    navJourney: "التشغيل",
    navOutcomes: "القيمة",
    statsLevels: "بوابات أدوار",
    statsModules: "وحدة تعلم",
    statsAssess: "نموذج قياس",
    statsServices: "مسارات تشغيل",
    dimEyebrow: "البوابات الرئيسية",
    dimTitle: "كل ما تحتاجه المدرسة في تجربة واحدة",
    dimSub: "صُممت منصة رواد لتكون قابلة لإعادة التسمية والتخصيص لكل مدرسة، مع نفس العمق التشغيلي.",
    dims: [
      { name: "المالك",  tag: "إشراف عام",       body: "إدارة المدارس، الصلاحيات، اختبارات القبول، التقارير المؤسسية، والتكاملات من لوحة مركزية." },
      { name: "الإدارة", tag: "تشغيل المدرسة",    body: "متابعة المشرفين والمستفيدين والمجموعات والورش والطلبات والنتائج داخل مدرسة العرض." },
      { name: "المشرف", tag: "تعلم ومتابعة",     body: "إدارة الحصص، الدروس، الاختبارات، الورش، المجموعات، وتقييم تطور المستفيدين." },
      { name: "المستفيد", tag: "رحلة شخصية",     body: "اختبارات قبول وتصنيف، وحدات تعلم، ألعاب تعليمية، مجتمع، ومتابعة تقدم واضحة." },
      { name: "القياس",  tag: "تقارير وقرارات",   body: "نماذج قياس، نقاط، تحليلات، مراجعات، وسجل تشغيلي يدعم القرار أمام المستثمرين." },
    ],
    journeyEyebrow: "تجربة العرض",
    journeyTitle: "من صفحة عامة إلى لوحة تشغيل كاملة",
    journeySub: "يمكن عرض المنصة كعلامة عامة على rowad.manzoma.sa، أو كمدرسة مستقلة على نطاقها الخاص مثل rowad-albania.",
    lvl: "خطوة",
    levels: [
      { t: "هوية عامة قابلة للتخصيص", d: "صفحة دخول وعرض لا ترتبط ببيانات مدرسة حقيقية." },
      { t: "مالك عام",              d: "يرى الصورة الشاملة والمدارس والقبول والتقارير." },
      { t: "إدارة مدرسة العرض",      d: "نفس وظائف الإدارة المدرسية لكن على بيانات تجريبية منفصلة." },
      { t: "رحلات تعلم وقياس",       d: "دروس، اختبارات، ورش، مجتمع، نقاط، وتحليلات قابلة للعرض." },
      { t: "عزل بيانات المدارس",     d: "كل نطاق مدرسي يحتفظ ببياناته وسياقه ومستخدميه." },
    ],
    outcomesEyebrow: "لماذا هذا مهم",
    outcomesTitle: "قيمة واضحة في العرض الاستثماري",
    outcomes: [
      "عرض آمن لا يكشف بيانات مدرسة ألبانيا أو أي مدرسة حقيقية",
      "إثبات أن المنصة قابلة للبيع كحل أبيض لعدة مدارس",
      "تجربة دخول واضحة للمالك والإدارة والمشرف والمستفيد",
      "لوحات تشغيل حقيقية بدل عرض تسويقي فقط",
      "بيانات تجريبية تساعد المستثمر على رؤية المنتج كما سيُستخدم فعلياً",
    ],
    finalEyebrow: "جاهزة للعرض",
    finalTitle: "ادخل كمالك أو مدير وشاهد المنصة تعمل.",
    finalSub: "هذه هي البيئة العامة لرواد: نظيفة، قابلة للتخصيص، ومعزولة عن بيانات المدارس الفعلية.",
    poweredBy: "جميع الحقوق محفوظة © منظومة - 2026",
  },
  en: {
    dir: "ltr" as const,
    brand: "Rowad Platform",
    eyebrow: "White-label school operating system",
    headline: "One platform to present any school with confidence",
    sub: "A general Rowad environment for schools and investors: owner console, school administration, supervisors, beneficiaries, learning content, measurement, reports, and community, with each school's data kept separate.",
    ctaJoin: "Owner / Admin Login",
    ctaExplore: "Explore the Platform",
    loginBtn: "Login",
    signupBtn: "Beneficiary Account",
    navAbout: "Platform",
    navDims: "Portals",
    navJourney: "Operations",
    navOutcomes: "Value",
    statsLevels: "Role Portals",
    statsModules: "Modules",
    statsAssess: "Assessment Models",
    statsServices: "Operating Flows",
    dimEyebrow: "Core Portals",
    dimTitle: "Everything a school needs in one branded experience",
    dimSub: "Rowad can be presented as a general white-label product, then adapted to each school without mixing data.",
    dims: [
      { name: "Owner",       tag: "General control",     body: "Manage schools, permissions, intake assessments, institutional reports, and integrations from one console." },
      { name: "Admin",       tag: "School operations",   body: "Run supervisors, beneficiaries, classes, workshops, applications, reviews, and results for the demo school." },
      { name: "Supervisor",  tag: "Learning delivery",   body: "Manage classes, lessons, quizzes, workshops, groups, and beneficiary development assessments." },
      { name: "Beneficiary", tag: "Personal journey",    body: "Move through intake, placement, learning modules, educational games, community, and progress tracking." },
      { name: "Measurement", tag: "Reports & decisions", body: "Use assessment models, points, analytics, reviews, and operational records to support decisions." },
    ],
    journeyEyebrow: "Demo Flow",
    journeyTitle: "From public landing to full operating dashboard",
    journeySub: "Show Rowad as a general product on rowad.manzoma.sa, or as a real school tenant on its own domain like rowad-albania.",
    lvl: "Step",
    levels: [
      { t: "General white-label identity", d: "A public presentation surface not tied to real school data." },
      { t: "General owner view",           d: "A platform owner can see the big picture, schools, intake, and reports." },
      { t: "Demo school administration",   d: "The admin experience has the same school tools, scoped to demo data." },
      { t: "Learning and measurement",     d: "Lessons, quizzes, workshops, community, points, and analytics are ready to show." },
      { t: "School data isolation",        d: "Each school domain keeps its own data, context, and users separate." },
    ],
    outcomesEyebrow: "Why it matters",
    outcomesTitle: "Investor-ready value",
    outcomes: [
      "A safe demo that does not expose Albania or any real school data",
      "Proof that Rowad can be sold as a white-label platform for many schools",
      "Clear owner, admin, supervisor, and beneficiary entry paths",
      "Real operating dashboards instead of a marketing-only tour",
      "Demo data that lets investors see how the product is actually used",
    ],
    finalEyebrow: "Ready to present",
    finalTitle: "Sign in as an owner or admin and see Rowad working.",
    finalSub: "This is the general Rowad environment: clean, brandable, and isolated from live school data.",
        ...
        <section id="top" className="gl-hero">
          ...
          <div className="gl-hero-body">
            ...
            <div className="gl-cta a5">
              <button className="gl-cta-solid"   onClick={goLogin}>
                {tr.ctaJoin}
