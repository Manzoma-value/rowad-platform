...
const T = {
  ...
  en: {
    ...
    sub: "Manage platform admins and issue invite links for new admins",
    createInvite: "Create invite",
    statActive: "Active admins",
    statSchools: "Total platforms",
    ...
    flashCopied: "Copied!",
    loading: "Loading...",
    secWithAdmin: "Platforms with an admin",
    secWithoutAdmin: "Platforms without an admin",
    ...
    emptyNoSchools: "No platforms registered yet",
    emptyNoSchoolsSub: "You need at least one platform before you can issue admin invites. Go to the Platforms page to create your first one.",
    emptyGoSchools: "Go to Platforms",
    emptyNoInvites: "No invites yet",
    emptyCreateFirst: "Create your first invite",
    modalTitle: "Create an admin invite",
    modalDesc: "Pick the platform you want to assign an admin to. The link will be sent to the recipient.",
    modalLabel: "Platform",
    modalPlaceholder: "— Pick a platform —",
    modalHint: "All platforms already have an admin or pending invite",
    modalCancel: "Cancel",
    ...
    errChooseSchool: "Please pick a platform first",
  },
} as const;
