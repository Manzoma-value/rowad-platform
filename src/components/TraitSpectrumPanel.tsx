  ...
  return (
    <section className={`tsp ${compact ? "tsp-compact" : ""}`} dir={lang === "ar" ? "rtl" : "ltr"}>
      ...
      <style>{`
        ...
        .tsp-visual{display:flex;align-items:center;justify-content:center;gap:18px;min-width:0;border:1px solid rgba(107,30,45,.08);border-radius:20px;background:#FFFFFF;padding:12px}.tsp-blob{position:relative;display:grid;place-items:center;flex:none}.tsp-total{position:absolute;inset-inline-end:5px;inset-block-end:8px;display:flex;align-items:baseline;gap:2px;border:1px solid rgba(107,30,45,.16);border-radius:10px;background:#FFFFFF;padding:6px 8px;box-shadow:0 6px 16px rgba(107,30,45,.09)}.tsp-total strong{font-size:16px;line-height:1;color:#8F765B}.tsp-total span{font-size:8px;color:#796A62;font-weight:900}.tsp-total.done strong{color:#1B5E20}.tsp-total.over strong{color:#6B1E2D}
