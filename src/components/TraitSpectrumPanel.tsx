  ...
  return (
    ...
    >
      ...
      <div className="tsp-main">
        <div className="tsp-visual">
          ...
          <div className="tsp-radar">
            <TraitRadarChart traits={traits} size={summary ? 210 : compact ? 118 : 144} />
      ...
      <style>{`
        ...
        .tsp-visual{position:relative;display:flex;align-items:center;justify-content:center;gap:22px;min-width:0;overflow:hidden;border:1px solid rgba(107,30,45,.12);border-radius:22px;background:radial-gradient(circle at 18% 18%,rgba(184,160,130,.16),transparent 30%),radial-gradient(circle at 82% 80%,rgba(107,30,45,.08),transparent 34%),linear-gradient(145deg,#F7F3EB,#EFEAE0);padding:16px}.tsp-visual:after{content:"";position:absolute;inset:10px;pointer-events:none;border:1px solid rgba(255,255,255,.78);border-radius:16px}.tsp-blob{position:relative;z-index:1;display:grid;place-items:center;flex:none}.tsp-total{position:absolute;inset-inline-end:5px;inset-block-end:8px;display:flex;align-items:baseline;gap:2px;border:1px solid rgba(107,30,45,.16);border-radius:10px;background:#FFFBF5;padding:6px 8px;box-shadow:0 6px 16px rgba(107,30,45,.09)}.tsp-total strong{font-size:16px;line-height:1;color:#8F765B}.tsp-total span{font-size:8px;color:#796A62;font-weight:900}.tsp-total.done strong{color:#1B5E20}.tsp-total.over strong{color:#6B1E2D}
        ...
        @media(max-width:520px){.tsp-summary .tsp-visual{gap:10px;padding:14px 8px;min-height:520px}.tsp-summary .tsp-radar{margin-top:-10px}}
      `}</style>
    </section>
  );
}
