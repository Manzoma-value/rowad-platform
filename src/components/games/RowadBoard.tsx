...
const styles = `
  ...
  .rbx-guide{display:flex;align-items:center;justify-content:center;gap:10px;margin:0 auto 16px;padding:12px 18px;max-width:760px;border-radius:17px;background:rgba(255,251,245,.78);border:1px solid rgba(184,160,130,.30);box-shadow:0 8px 22px rgba(107,30,45,.055);backdrop-filter:blur(12px)}
  .rbx-guide>i{width:clamp(22px,5vw,72px);height:2px;background:rgba(184,160,130,.28)}
  .rbx-guide-step{display:flex;align-items:center;gap:7px;color:#8C8274;font-size:11px;font-weight:800;white-space:nowrap}.rbx-guide-step b{display:grid;place-items:center;width:27px;height:27px;border-radius:9px;background:#EFEAE0;border:1px solid rgba(184,160,130,.32);font-size:10px}.rbx-guide-step.active{color:#4a0e1c}.rbx-guide-step.active b{color:#d9c9b0;background:linear-gradient(145deg,#6b1e2d,#32101a);border-color:#6b1e2d;box-shadow:0 5px 13px rgba(107,30,45,.20)}.rbx-guide-step.done b{font-size:0;color:white;background:#1b5e20;border-color:#1b5e20}.rbx-guide-step.done b::after{content:'✓';font-size:11px}

  .rbx-tray{position:relative;padding:16px 18px 18px;margin-bottom:14px;border:1px solid rgba(184,160,130,.36);border-radius:20px;background:linear-gradient(145deg,rgba(255,251,245,.90),rgba(239,234,224,.82));box-shadow:0 14px 36px rgba(107,30,45,.075),inset 0 1px 0 #fff}
  ...
  .rbx-search{display:flex;align-items:center;gap:7px;min-width:220px;height:36px;padding:0 11px;border-radius:11px;background:rgba(255,255,255,.72);border:1px solid rgba(184,160,130,.32);color:#8C8274}.rbx-search input{width:100%;min-width:0;border:0;outline:0;background:transparent;color:#4a0e1c;font:600 12px 'Cairo',sans-serif}.rbx-search input::placeholder{color:#B8A082}
  .rbx-tool-btn{height:36px;padding:0 12px;border-radius:11px;border:1px solid rgba(107,30,45,.18);background:rgba(255,255,255,.68);color:#6b1e2d;font:800 11px 'Cairo',sans-serif;cursor:pointer;transition:.16s}.rbx-tool-btn:hover:not(:disabled){transform:translateY(-1px);background:#fff;border-color:rgba(107,30,45,.34)}.rbx-tool-btn.danger{color:#6B1E2D;background:rgba(107,30,45,.045)}.rbx-tool-btn:disabled{opacity:.38;cursor:not-allowed}
  .rbx-selected-banner{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:16px;margin:0 0 13px;padding:12px 14px;border-radius:14px;color:#F7F3EB;background:linear-gradient(115deg,#4a0e1c,#6B1E2D);border:1px solid rgba(217,201,176,.38);box-shadow:0 9px 20px rgba(107,30,45,.18);animation:rbx-chipin .2s ease}.rbx-selected-banner div{display:flex;flex-direction:column}.rbx-selected-banner small{color:#D9C9B0;font-size:9px;font-weight:800;letter-spacing:.06em}.rbx-selected-banner strong{font-size:13px}.rbx-selected-banner p{margin:0;color:rgba(255,251,245,.76);font-size:11.5px;text-align:center}.rbx-selected-banner button{border:1px solid rgba(217,201,176,.32);border-radius:9px;background:rgba(255,255,255,.08);color:#E5E0D5;padding:7px 10px;font:700 10px 'Cairo',sans-serif;cursor:pointer}
  .rbx-tray-cards{max-height:210px;overflow-y:auto;align-content:flex-start;padding:2px 3px 5px;scrollbar-width:thin;scrollbar-color:#b8a082 transparent}.rbx-card{border-radius:13px;padding-block:9px}.rbx-card.sel{color:#F7F3EB!important;background:linear-gradient(135deg,#6b1e2d,#32101a)!important;border-color:#b8a082!important;box-shadow:0 10px 22px rgba(107,30,45,.28)!important}.rbx-tray-empty.muted{color:#8C8274}
  .rbx-scroll-hint{display:none;margin:4px 0 9px;color:#796A62;font-size:10.5px;font-weight:700;text-align:center}
  ...
  .rbx-frame{box-shadow:0 20px 55px rgba(107,30,45,.11),inset 0 1px 0 #fff}
  .rbx-instructions{max-width:760px;margin:14px auto;color:#655B53;background:rgba(255,251,245,.62);border:1px solid rgba(184,160,130,.23);border-radius:12px;padding:10px 14px}
  .rbx-footer{position:sticky;bottom:10px;z-index:25;margin:14px auto 0;max-width:980px;padding:13px 15px;border-radius:18px;background:rgba(255,251,245,.90);border:1px solid rgba(184,160,130,.38);box-shadow:0 16px 38px rgba(107,30,45,.17);backdrop-filter:blur(16px)}
