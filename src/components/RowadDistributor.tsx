...
export default function RowadDistributor({
  ...
  return (
    <div className={`rwd ${disabled ? "rwd-disabled" : ""}`}>
      ...
      <style>{`
        .rwd { background: linear-gradient(180deg,#FFFBF5,#FBF6E9); border:1.5px solid rgba(194,160,89,0.32); border-radius:14px; padding:14px; font-family:'Cairo',sans-serif; }
        ...
        .rwd-status-ok    { background:rgba(76,107,60,0.12);  color:#1B5E20; }
        .rwd-status-over  { background:rgba(163,59,46,0.10); color:#A33B2E; }
        .rwd-status-under { background:rgba(199,154,61,0.14);color:#8F765B; }

        .rwd-sliders { display:grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap:10px; }
        .rwd-row { background:#FFFBF5; border:1px solid rgba(194,160,89,0.18); border-radius:12px; padding:10px 12px; display:grid; grid-template-columns: 1fr 58px; column-gap:10px; align-items:center; }
