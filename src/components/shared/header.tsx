...
export default function Header({ title }: HeaderProps) {
  return (
    <header className="sticky top-0 z-30 flex min-h-[68px] items-center justify-between gap-4 border-b border-black/10 bg-[#FFFBF5]/85 px-4 py-3 shadow-[0_8px_28px_rgba(26,26,26,0.04)] backdrop-blur-xl sm:px-6 lg:px-10">
